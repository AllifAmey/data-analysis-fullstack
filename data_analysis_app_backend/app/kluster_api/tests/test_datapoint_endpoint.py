...
class TestDatapointEndpoint(TestCase):
    ...
    def test_datapoint(self):
        ...
        with 2 datasets and 1 datapoint each.
        """
        ...
        self.assertEqual(res.data, {
            "dataset_1": [{"id": 1, "dataset": 1, "data": 1}],
            "dataset_2": [{"id": 2, "dataset": 2, "data": 2}]})
        """
        ...
        """
        Test for POST request creates model
        and the get request returns correctly.
        """
        ...
        serializer_dataset_1 = DataPointSerializer(
            dataset_1_datapoints, many=True)
        serializer_dataset_2 = DataPointSerializer(
            dataset_2_datapoints, many=True)
        res = client.get("/api/datapoint/")
        self.assertEqual(res.data, {
            "dataset_1": serializer_dataset_1.data,
        ...
        self.assertEqual(res.status_code, 200)
        self.assertEqual(res.data, {
            'Message': 'Datapoint delete successfully'})
